...
class App extends Component {
  ...
  async componentDidMount() {
    ...
    const { data: posts } = await http.get(config.apiEndpoint); //when using await decorate function with async
    this.setState({ posts });

    //console.log(promise);
    //const response = await promise; //when using await decorate function with async
  }
